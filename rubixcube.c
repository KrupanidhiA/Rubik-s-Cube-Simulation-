...
int solve[300],count=0,rotationcomplete=0;
...
void display(void)
{
		...
		if(rotation==1)
		{
			...
			else
			{
				glPushMatrix();
				glColor3fv(color[0]);
				output(-11,6,"Top counter-clockwise");
				glPopMatrix();
				glRotatef(theta,0.0,1.0,0.0);
			}
			colorcube5();
		...
		{	
			...
			else
			{
				glPushMatrix();
				glColor3fv(color[0]);
				output(-11,6,"Right counter-clockwise");
				glPopMatrix();
				glRotatef(theta,1.0,0.0,0.0);
			}	
			colorcube4();
		...
		if(rotation==3)
		{
			...
			else
			{
				glPushMatrix();
				glColor3fv(color[0]);
				output(-11,6,"Front counter-clockwise");
				glPopMatrix();
				glRotatef(theta,0.0,0.0,1.0);
			}
		...
		{ 
			...
			else
			{
				glPushMatrix();
				glColor3fv(color[0]);
				output(-11,6,"Left counter-clockwise");
				glPopMatrix();
				glRotatef(-theta,1.0,0.0,0.0);
			}
			colorcube3();
		...
		{ 
			...
			else
			{
				glPushMatrix();
				glColor3fv(color[0]);
				output(-11,6,"Back counter-clockwise");
				glPopMatrix();
				glRotatef(-theta,0.0,0.0,1.0);
			}
			colorcube7();
		...
		{ 
			...
			else
			{
				glPushMatrix();
				glColor3fv(color[0]);
				output(-11,6,"Bottom counter-clockwise");
				glPopMatrix();
				glRotatef(-theta,0.0,1.0,0.0);
			}
			colorcube2();
...
void ColorMenu(int id)
{
	switch(id)
	{
		...
		case 3:	//Forest Green
			...
			break;
		case 4:	//Gold
			glClearColor(255,215,0,1);
			break;
		case 5:	
			glClearColor(255,20,147,1);
			break;
		case 6 ://Iron Grey
...
int main(int argc, char** argv)
{
	...
	glClearColor(1,1,1,1);
	int sub_menu_id1=glutCreateMenu(MovementMenu);
	glutAddMenuEntry("Top clockwise                        :a",1);
	glutAddMenuEntry("Top counter-clockwise         :q",2);
	glutAddMenuEntry("Right clockwise                      :s",3);
	glutAddMenuEntry("Right counter-clockwise       :w",4);
	glutAddMenuEntry("Front clockwise                      :d",5);
	glutAddMenuEntry("Front counter-clockwise       :e",6);
	glutAddMenuEntry("Left clockwise                         :f",7);
	glutAddMenuEntry("Left counter-clockwise         	:r",8);
	glutAddMenuEntry("Back clockwise                      :g",9);
	glutAddMenuEntry("Back counter-clockwise       	:t",10);
	glutAddMenuEntry("Bottom clockwise                  :h",11);
	glutAddMenuEntry("Bottom counter-clockwise   :y",12);
	
	int sub_menu_id2=glutCreateMenu(ColorMenu);
	glutAddMenuEntry("White               ",0);
	glutAddMenuEntry("Pitch Black         ",1);
	glutAddMenuEntry("Maroon              ",2);
	glutAddMenuEntry("Forest Green	      ",3);
	glutAddMenuEntry("Gold	              ",4);
	//glutAddMenuEntry("Deep Pink	      ",5);
 	glutAddMenuEntry("Iron Grey	      ",6);
	
	glutCreateMenu(MainMenu);
    	glutAddSubMenu("Rubix Cube Movements  ", sub_menu_id1);
	glutAddSubMenu("Background Color    ", sub_menu_id2);
